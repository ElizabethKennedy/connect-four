...
const getWinner = (
  ...
  // check if there is more than 4 counters in segment
  ...
  // if every color in segment is the same, win return
  // winner color and win combo segments
...
// Check for all possible horizontal segments near counter that were placed
...
// Check for all possible vertical segments near counter that were placed
